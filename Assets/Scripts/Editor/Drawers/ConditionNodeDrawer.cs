...
public class ConditionNodeDrawer : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (property.managedReferenceValue == null)
        {
            ...
            if (GUI.Button(createRect, "Create ConditionNode"))
        ...
        if ((ConditionOperator)op.enumValueIndex == ConditionOperator.Leaf)
        {
            y = DrawField(position, y, property.FindPropertyRelative("leafType"));
            y = DrawField(position, y, property.FindPropertyRelative("floatValue"));
            y = DrawField(position, y, property.FindPropertyRelative("stringValue"));
            y = DrawField(position, y, property.FindPropertyRelative("referencedCondition"));
        }
        else
        {
    ...
    public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
    {
        ...
        if ((ConditionOperator)op.enumValueIndex == ConditionOperator.Leaf)
        {
            ...
            height += EditorGUIUtility.standardVerticalSpacing + EditorGUI.GetPropertyHeight(property.FindPropertyRelative("floatValue"), true);
            height += EditorGUIUtility.standardVerticalSpacing + EditorGUI.GetPropertyHeight(property.FindPropertyRelative("stringValue"), true);
            height += EditorGUIUtility.standardVerticalSpacing + EditorGUI.GetPropertyHeight(property.FindPropertyRelative("referencedCondition"), true);
        }
        else
        {
