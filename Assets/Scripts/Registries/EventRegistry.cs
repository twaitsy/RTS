...
public class EventRegistry : DefinitionRegistry<EventDefinition>
{
    ...
    protected override void ValidateDefinitions(List<EventDefinition> defs)
    {
        if (StatModifierRegistry.Instance == null || StatRegistry.Instance == null)
        {
            Debug.LogError("EventRegistry validation skipped: StatModifierRegistry or StatRegistry instance is null.");
            return;
        }
